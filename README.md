...
# Toxicity Collection
- Moderate Hatespeech API - retreieves toxicity moderation score using predicted class and confidence score given a string of text https://moderatehatespeech.com/docs/ 
